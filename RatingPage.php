...
<center><h1>Rate <b>'.$_SESSION['OtherUser'].' </b></center></h1>';
echo'
	
  <div class="feedback">
    <div class="rating">
      <input type="radio" name="ratingnumber" value="5" id="rating-5">
      <label for="rating-5"></label>
      <input type="radio" name="ratingnumber" value="4" id="rating-4">
      <label for="rating-4"></label>
      <input type="radio" name="ratingnumber" value="3" id="rating-3" checked>
      <label for="rating-3"></label>
      <input type="radio" name="ratingnumber" value="2" id="rating-2">
      <label for="rating-2"></label>
      <input type="radio" name="ratingnumber" value="1" id="rating-1">
    ...
    <ellipse transform="scale(-1) rotate(45 454 -421.3)" cx="174.5" cy="188" rx="12" ry="8.1" fill="#fff"/>
		...
		<b>Review:</b></br>
		<input type="text" name="reviewtext" style="width:90%;height:20%;" placeholder="Review User"></br></br>';


if($Type=="Buyer"){
	echo'<h2>Review Product:'.$ContractsObj->ProductID.'</label></h2><b>Review:</b></br>';
	
	echo'<input type="text" name="reviewtextproduct" style="width:90%;height:20%;" placeholder="Review Product"></br></br>';
